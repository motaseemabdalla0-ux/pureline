...
export default function Navbar() {
  ...
  const { isAuthenticated, user, logout } = usePlatformAuth()
        ...
        <div className="flex items-center gap-2">
          ...
          {isAuthenticated ? (
            <div className="hidden items-center gap-1.5 lg:flex">
              ...
              <Link to="/platform/pests" className="flex items-center gap-1.5 rounded-full px-3.5 py-2.5 text-sm font-semibold text-neutral-dark/80 transition hover:bg-primary/10 hover:text-primary dark:text-neutral-light/80 dark:hover:text-secondary">
                <Bug className="h-4 w-4" /> {t('navPlatform.pestManagement')}
              </Link>
              ...
              {user?.role === 'admin' && (
                <Link to="/platform/users" className="flex items-center gap-1.5 rounded-full px-3.5 py-2.5 text-sm font-semibold text-neutral-dark/80 transition hover:bg-primary/10 hover:text-primary dark:text-neutral-light/80 dark:hover:text-secondary">
            ...
            <div className="container-px flex max-h-[70vh] flex-col gap-1 overflow-y-auto py-4">
              ...
              {isAuthenticated ? (
                <div className="mt-2 flex flex-col gap-1 border-t border-black/5 pt-3 dark:border-white/10">
                  ...
                  <Link to="/platform/pests" onClick={() => setOpen(false)} className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold text-neutral-dark/80 hover:bg-primary/10 dark:text-neutral-light/80">
                    <Bug className="h-4 w-4 shrink-0" /> {t('navPlatform.pestManagement')}
                  </Link>
                  ...
                  {user?.role === 'admin' && (
                    <Link to="/platform/users" onClick={() => setOpen(false)} className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold text-neutral-dark/80 hover:bg-primary/10 dark:text-neutral-light/80">
